...
By default Dockview resolves a drop from the quadrant of the target the cursor happens to be over. The **DnD compass**
...
<CodeRunner id="dockview/dnd-compass" />
...
<FrameworkSpecific framework="React">
    <DocRef declaration="IDockviewReactProps" methods={['dndCompass']} />
</FrameworkSpecific>

<FrameworkSpecific framework="Vue">
    <DocRef declaration="IDockviewVueProps" methods={['dndCompass']} />
</FrameworkSpecific>

<FrameworkSpecific framework="JavaScript">
    <DocRef declaration="DockviewComponentOptions" methods={['dndCompass']} />
</FrameworkSpecific>

<FrameworkSpecific framework="Angular">
    <DocRef declaration="DockviewAngularOptions" methods={['dndCompass']} />
</FrameworkSpecific>
