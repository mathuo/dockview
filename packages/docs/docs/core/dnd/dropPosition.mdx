...
:::info
The visual aim-at-a-cell overlay is covered in [DnD compass](/docs/core/dnd/dndCompass). That compass (`dndCompass`)
installs its own resolver, so enable one or the other: `dndCompass` when you want the built-in aim-at-a-cell affordance,
...
- [DnD compass](/docs/core/dnd/dndCompass): the aim-at-a-cell compass built on top of this resolver.
