...
<CodeRunner id="dockview/drop-guide" height={300} />
...
- [Drop Position Resolver](/docs/core/dnd/dropPosition) — a free, lower-level seam to override where a pointer maps to a drop position.
