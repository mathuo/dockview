...
<FrameworkSpecific framework="JavaScript">
    ```js import 'dockview/dist/styles/dockview.css'; ```
</FrameworkSpecific>

<FrameworkSpecific framework="React">
    ```js import 'dockview-react/dist/styles/dockview.css'; ```
</FrameworkSpecific>

<FrameworkSpecific framework="Vue">
    ```js import 'dockview-vue/dist/styles/dockview.css'; ```
</FrameworkSpecific>

<FrameworkSpecific framework="Angular">
    ```js import 'dockview-angular/dist/styles/dockview.css'; ```
</FrameworkSpecific>
...
<FrameworkSpecific framework='JavaScript'>
```ts
import { createDockview, themeAbyss, IContentRenderer, GroupPanelPartInitParameters } from 'dockview';
