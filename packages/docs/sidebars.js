    ...
    tutorialSidebar: [
        {
            type: 'html',
            value: 'Overview',
            className: 'menu__link sidebar-section-header',
        },
        {
            type: 'category',
            label: 'Get Started',
        ...
        },
        {
            ...
            collapsible: true,
            collapsed: true,
            items: [{ type: 'autogenerated', dirName: 'core/panels' }],
        },
        {
            type: 'category',
            label: 'Groups',
            collapsible: true,
            collapsed: true,
            items: [{ type: 'autogenerated', dirName: 'core/groups' }],
        },
        {
            type: 'category',
            label: 'Tabs',
            collapsible: true,
            collapsed: true,
            items: [{ type: 'autogenerated', dirName: 'core/tabs' }],
        },
        // {
        //     type: 'category',
        //     label: 'Gridview',
